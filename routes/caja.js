...
// POST /api/caja/abrir
router.post('/abrir', auth, requireRole('admin', 'cajero'), async (req, res) => {
...
router.post('/cerrar/:id', auth, requireRole('admin', 'cajero'), async (req, res) => {
...
router.post('/gastos', auth, requireRole('admin', 'cajero'), async (req, res) => {
